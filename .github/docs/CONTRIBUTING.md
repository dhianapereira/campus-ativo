...
# Troque <nome-da-branch> pelo nome da funcionalidade que você implementará (ex.: create-login-route)
```
...
# troque "." pelo endereço do arquivo (ex.: "git add src/services/auth.ts")
```
...
Caso você ainda não sinta segurança em contribuir com código ou encontrou um problema/situação de melhoria e quer reportar, crie uma [_issue_](https://github.com/campusativo/ifal-arapiraca-backend/issues/new).
