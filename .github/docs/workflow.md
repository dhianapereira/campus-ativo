...
## [Quadro do Github](https://github.com/orgs/campusativo/projects/7)
...
![Quadro do Github](https://github.com/campusativo/ifal-arapiraca-backend/assets/40719464/616d2852-582f-48a7-91f5-20850eebd391)


## Regras/Acordos 

- Quando uma tarefa estiver em `BACKLOG` (mesmo que você seja o responsável pela tarefa), não deve ser movida para o desenvolvimento;
- Apenas tarefas em `TODO` podem ser movidas para o desenvolvimento;
...
- Mantenha o conteúdo do seu card sempre atualizado. Não se esqueça de preencher a coluna de informações (responsável pela issue, label...).
